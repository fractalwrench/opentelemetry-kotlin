...
/**
 * Sets attributes on an [io.opentelemetry.kotlin.attributes.WritableAttributes] from a [Map].
...
@ExperimentalApi
@ThreadSafe
public fun WritableAttributes.setAttributes(attributes: Map<String, Any>) {
    attributes.forEach {
...
private fun WritableAttributes.handleCollection(key: String, input: List<*>) {
    when {

...
This module resolves the configuration supplied by every mechanism into the single `config-model`
...
`config-yaml`, then applies the precedence rules defined in `config-model`.

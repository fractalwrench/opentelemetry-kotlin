...
internal object NoopSpan : Span {
    ...
    override fun addLink(spanContext: SpanContext, attributes: (WritableAttributes.() -> Unit)?) {
    }

    override fun addEvent(name: String, timestamp: Long?, attributes: (WritableAttributes.() -> Unit)?) {
    }

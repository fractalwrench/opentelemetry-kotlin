 ...
 */
@ExperimentalApi
public interface SpanRelationships : WritableAttributes {

    /**
     * Adds a link to the span that associates it with another [SpanContext].
     */
    @ThreadSafe
    public fun addLink(spanContext: SpanContext, attributes: (WritableAttributes.() -> Unit)? = null)
    ...
    public fun addEvent(
        name: String,
        timestamp: Long? = null,
        attributes: (WritableAttributes.() -> Unit)? = null,
    )
}
